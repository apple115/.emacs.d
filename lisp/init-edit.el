...
(use-package evil-collection
  ...
  :demand t
  :config
  (setq evil-collection-mode-list '(ibuffer calendar eat ediff magit realgud compile docker dape vertico xref corfu mini-buffer consult woman man citre gptel cider citre))
